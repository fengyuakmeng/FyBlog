...
function traverseNode(reply){
    result += "<article class=\"r_"+ reply['id']+" media box\">";
    ...
    result += "<strong class=\"comment_nick\" >"+"<cva href='/user/"+reply['user_id']+"'"+">" + reply['user'] +"</cva>"+"</strong><br>";
        ...
        dataType:"json",
            ...
            success:function (data) {
                ...
                for (var i=0;i<comment_data.length;i++){
                    result += "<article class=\"c_"+ comment_data[i]['id']+" media box\">";
                    result += "<figure class=\"avatars media-left\">";
                    ...
                    result += "<div class=\"comment media-content\">";
                    result += "<div class=\"comment_content\" style=\"font-size: 17px;\">";
                    result += "<strong class=\"comment_nick\" >"+ "<a href='/user/"+comment_data[i]['user_id']+"'"+">" + comment_data[i]['user'] +"</a>"+"</strong><br>";
